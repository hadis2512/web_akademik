            ...
            <div id="content">
                ...
                <div class="container-fluid" id="container-wrapper">
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800 py-3">Add Surat</h1>
                                        ...
                                        <fieldset class="form-group">
                                            <div class="row">
                                                ...
                                                foreach ($jenis_permohonan as $a) { ?>
                                                    <div class="col-sm-3">
                                                        <div class="custom-control custom-radio">
                                                            <input type="radio" id="jenis_permohonan<?= $a['id'] ?>" name="jenis_permohonan" value="<?= $a['id'] ?>" class="custom-control-input">
                                                            <label class="custom-control-label" for="jenis_permohonan<?= $a['id'] ?>"><?= $a['nama'] ?></label>
                                                        </div>
                                                    </div>
                                                <?php }
                                                ?>
