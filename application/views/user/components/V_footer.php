        ...
        const dataCard = (indexStart, indexEnd) => {
          ...
          dataSliced.forEach((res, index) => {
            if (res.approval_admin == 0) {
              var status = '<div class="badge badge-warning align-self-start"><i class="fas fa-check mr-2"></i>Terkirim</div>';
            } else if (res.approval_admin == 1 && res.status_surat == 0) {
              ...
              var status = '<div class="badge badge-danger align-self-start"><i class="fas fa-xmark mr-2"></i>Reject</div>';
            } else if (res.approval_admin == 1 && res.status_surat == 1) {
        ...
        $.ajax({
          ...
          success: function(data) {
            ...
            data1.forEach((res, index) => {
              // console.log(res);
              var download_surat = `<?= base_url("user/User/download_surat/") ?>${jenis_permohonan}/${id_formulir}`
              if (res.approval_admin == 0) {
                var status = '<div class="badge badge-warning align-self-start"><i class="fas fa-check mr-2"></i>Terkirim</div>';
                var log =
                  '<div class="w-100 badge badge-success">Formulir sudah terkirim ke <b>Admin</b>, silahkan tunggu!</div>';
              } else if (res.approval_admin == 1 && res.status_surat == 0) {
                var status = '<div class="badge badge-success align-self-start"><i class="fas fa-check mr-2"></i>Approve</div>';
                var log =
                  '<div class="w-100 badge badge-success">Formulir sudah di approve oleh <b>Admin</b>, silahkan tunggu untuk pembuatan suratnya!</div>';
              } else if (res.approval_admin == 2) {
                var status = '<div class="badge badge-danger align-self-start"><i class="fas fa-xmark mr-2"></i>Reject</div>';
                var log =
                ...
                var status = '<div class="badge badge-success align-self-start"><i class="fas fa-check mr-2"></i>Surat</div>';
                var log =
                  `<a href="<?= base_url('user/User/download_surat/') ?>${res.id_jenis_permohonan}/${res.id_surat}" class="btn btn-info mx-auto"><i class="fa-solid fa-print mr-2"></i>Cetak Surat</a>`;
              }
                                                  ...
                                                  <div id="collapseIji" class="collapse" aria-labelledby="headingOne" data-parent="#accordion">
                                                    ...
                                                    <div class="form-group row mt-2">
                                                        <div class="col-lg-6">
                                                          ...
                                                          <input type="text" class="form-control" id="exampleInputUsername1" placeholder="Jenis Permohonan" value="${res.jenis_permohonan}" readonly>
                                                        </div>
                                                        <div class="col-lg-6">
                                                          <label for="exampleInputUsername1" class="">Jenis Tugas</label>
                                                          <input type="text" class="form-control " id="exampleInputUsername1" placeholder="Jenis Tugas" value="${res.jenis_tugas}" readonly>
                                                        </div>                                        
                                                    </div> 
                                                    <div class="form-group row">
                                                        <div class="col-lg-12">
                                                          <label for="exampleInputUsername1">Judul Tugas</label>
                                                          <input type="text" class="form-control" id="exampleInputUsername1" placeholder="Judul Tugas" value="${res.judul_tugas}" readonly>
                                                        </div>                                                    
                                                    </div>   
                                                    <div class="form-group row">
                                                        <div class="col-lg-6">
                                                          <label for="exampleInputUsername1">Nama Perusahaan</label>
                                                          <input type="text" class="form-control" id="exampleInputUsername1" placeholder="Nama Perushaan" value="${res.nama_perusahaan}"readonly>
                                                        </div>
                                                        <div class="col-lg-6">
                                                          <label for="exampleInputUsername1" class="">Alamat Surat</label>
                                                          <input type="text" class="form-control " id="exampleInputUsername1" placeholder="Alamat Surat" value="${res.alamat_surat}" readonly>
                                                        </div>                                        
                                                    </div> 
                                                    <div class="form-group row">
                                                        <div class="col-lg-6">
                                                          <label for="exampleInputUsername1">Perwakilan Perusahaan</label>
                                                          <input type="text" class="form-control" id="exampleInputUsername1" placeholder="Perwakilan Perusahaan" value="${res.perwakilan_perusahaan}" readonly>
                                                        </div>                                                    
                                                        <div class="col-lg-6">
                                                          <label for="exampleInputUsername1">Jabatan Perwakilan</label>
                                                          <input type="text" class="form-control" id="exampleInputUsername1" placeholder="Jabatan Perwakilan" value="${res.jabatan_perwakilan}" readonly>
                                                        </div>                                                    
                                                    </div>                                                                                                 
                                                    <div class="form-group row">
                                                        <div class="col-lg-12">
                                                          <label for="exampleInputUsername1">Telp Perusahaan</label>
                                                          <input type="text" class="form-control" id="exampleInputUsername1" placeholder="Telp Perusahaan" value="${res.no_telp_perusahaan}" readonly>
                                                        </div>                                                    
                                                    </div>                                                                                              
                                              </form>
                                            </div>
