	...
	**/
	var isDragged		= false,
		...
		templates 		= {
							...
							buttonSave		: $('<button type="submit" class="btn btn-primary btn-sm ml-1" id="bcPaint-export"><i class="fas fa-download"></i> Export</button>')
						},
		paintCanvas,
		paintContext;
	...
	$.extend(true, $.fn.bcPaint, {
		...
		*/
		export : function(){
			...
			var test2= test.attr("value", img[1]);
			
			$.ajax({				
					type: 'POST',
					url: `http://localhost/web_akademik/superadmin/master_data/ttd_test`,
